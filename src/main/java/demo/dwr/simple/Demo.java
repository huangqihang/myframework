...
public class Demo
{
    ...
    public String getInclude() throws ServletException, IOException
    {
        ...
        return wctx.forwardToString("/WEB-INF/views/jsp/dwr/simple/forward.html");
    }
    
    public String getIncludeJsp() throws ServletException, IOException
    {
    	WebContext wctx = WebContextFactory.get();
    	return wctx.forwardToString("/WEB-INF/views/jsp/dwr/simple/include.jsp");
    }
}
